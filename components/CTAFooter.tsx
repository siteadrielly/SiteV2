...
export function FinalCTA() {
  return (
    <section
      id="contato"
      className="relative bg-gradient-to-b from-espresso to-black text-center py-24 px-[6vw]"
    >
      <Reveal className="max-w-[640px] mx-auto relative z-10">
        ...
        <h2 className="font-display text-ivory text-3xl md:text-4xl max-w-[16ch] mx-auto pt-1">
          Vamos conversar sobre o seu rosto.
        </h2>

        <p className="text-ivory/70 font-light mt-5 max-w-[46ch] mx-auto">
          Agende uma avaliação e entenda, com calma, o que faz sentido para
          você — sem compromisso e sem pressa.
        </p>
        ...
        <div className="flex gap-4 justify-center mt-9 flex-wrap">
          ...
          <a
            href="https://instagram.com/draadrielyanute"
  ...
  return (
    <footer className="bg-black text-ivory/70 pt-14 pb-9 px-[6vw] border-t border-line">
      <div className="max-w-[1220px] mx-auto flex flex-wrap justify-between gap-9">
        <div>
          <h4 className="text-gold text-[0.7rem] tracking-[0.2em] uppercase mb-3">
            Dra. Adriely Anute
          </h4>

          <p className="text-sm font-light mb-1.5">
        ...
        <div>
          ...
          <a
            href="#sobre"
            className="block text-sm font-light mb-1.5 hover:text-gold-light"
          >
            Sobre
          </a>
      ...
      <div className="max-w-[1220px] mx-auto flex flex-wrap justify-between gap-2 mt-10 pt-6 border-t border-line text-xs text-ivory/50">
        <span>
          © {new Date().getFullYear()} Dra. Adriely Anute. Todos os direitos
          reservados.
        </span>

        <span>
          CRO-PB 7284 - v{pkg.version}
        </span>
      </div>
